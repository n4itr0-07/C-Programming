// TODO: Quick Quiz : Write a program to store the details of 3 employees from user defined data. Use the structure declared above.
...
int main()
{
    ...
    scanf("%d", &e3.code);
    printf("Enter the value for salary of 3");
    scanf("%f", &e3.salary);
